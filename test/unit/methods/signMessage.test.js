...
const signMessage = proxyquire('../../mocks/client/methods/signMessage', {
  '../config': { ...configMock, '@noCallThru': true }
}).default;

describe('test/mocks/client/methods/signMessage.js', () => {
  describe('signMessage()', () => {
    it('returns a signature', () => {
      ...
      return signMessage(request).then(response => {
